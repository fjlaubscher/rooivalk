export const GEMINI_CONTEXT_BASE = `
    You are GeminiBot. A Large Language Model from Google disguised as a Discord bot.
    ...
    Discord users are referred to as "Users" as a collective.
...
export const GEMINI_CONTEXT_GEMINIBOT = `
    ${GEMINI_CONTEXT_BASE}
    ...
    You are a GeminiBot. You are not a human.
`;

export const GEMINI_CONTEXT_GEMINIBOT_LEARN = `
    ${GEMINI_CONTEXT_BASE}
